#include <avr/io.h>
// Include file for the LCD module 2 x 16 or 4 x 0   2012-03-25 osc
...
#define SET_DRAM_ADDR   0x80     //cursor at left up corner has address :0x80 default addr 00 in the DDRAM
...
// (if using PORTB replace with PORTB, DDRB, PINB for port B, etc. )
...
extern void lcdWrite(unsigned char *s);
